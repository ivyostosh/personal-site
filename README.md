...
```bash
git clone git://github.com/ivyostosh/personal-site.git # replace [ivyostosh] with your github username if you fork first.
cd personal-site
...
* Template based on [Michael D'Angelo's Personal Website](https://github.com/mldangelo/personal-site).